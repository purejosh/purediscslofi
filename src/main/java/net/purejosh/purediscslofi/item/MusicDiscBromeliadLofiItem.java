...
public class MusicDiscBromeliadLofiItem extends RecordItem {
	public MusicDiscBromeliadLofiItem() {
		super(14, PurediscslofiModSounds.BROMELIAD_LOFI, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 4466);
